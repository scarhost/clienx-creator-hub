...
const resumeTemplates = [
  ...
  },
  {
    ...
    image: "https://placehold.co/600x400/808080/FFFFFF/?text=Creative+Resume",
    previewUrl: "https://kzmgi522ped7f70ydq3a.lite.vusercontent.net"
  },
  {
    id: 3,
    ...
    image: "https://placehold.co/600x400/808080/FFFFFF/?text=Technical+Resume",
    previewUrl: "https://kzmgi522ped7f70ydq3a.lite.vusercontent.net"
  },
];
...
const ResumeTemplates = () => {
  ...
  const handleTemplateSelect = (templateId: number) => {
    ...
    navigate(`/request/resume/${templateId}`);
  };
    ...
    <MainLayout>
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold">Resume Website Templates</h1>
            <p className="text-gray-400 mt-2">Select a template for your online resume</p>
          </div>
        </div>
